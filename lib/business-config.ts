...
export const CATEGORY_FIELD_SCHEMAS: Record<string, CategoryFieldSchema> = {
  ...
  medicine: {
    ...
    fields: [
      ...
      },
      {
        ...
        type: "text",
        placeholder: "e.g., Not for children under 12",
        fullWidth: true,
      },
      {
        key: "storageInstructions",
  ...
  hardware: {
    ...
    fields: [
      ...
      {
        key: "voltage",
        label: "Voltage (if applicable)",
        type: "text",
        placeholder: "e.g., 18V, 230V",
      },
      {
        key: "warranty",
        label: "Warranty",
  ...
  building_material: {
    ...
    fields: [
      ...
      },
      {
        ...
        label: "Unit Size",
        type: "text",
        placeholder: "e.g., Per bag, Per sheet",
      },
      {
        key: "grade",
        label: "Grade/Quality",
 ...
 */
export function getFieldSchemaForCategory(
  categoryName: string,
): CategoryFieldSchema | null {
