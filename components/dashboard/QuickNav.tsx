...
import { LayoutDashboard, Package, Truck, ShoppingCart, BarChart3, Users, Settings, HelpCircle } from 'lucide-react';
  ...
  return (
    <Card className="mb-4 sm:mb-6 bg-gradient-to-r from-green-50 dark:from-teal-900 to-emerald-50 dark:to-slate-800 border-green-200 dark:border-teal-700">
      <CardHeader className="p-3 sm:p-6 pb-2 sm:pb-4">
        <CardTitle className="text-green-800 dark:text-teal-300 text-lg sm:text-xl">Quick Navigation</CardTitle>
      </CardHeader>
          ...
          {visibleItems.map((item) => {
            ...
            return (
              ...
              >
                ...
                <span className="text-xs sm:text-sm font-medium text-gray-700 dark:text-teal-100 text-center">{item.label}</span>
              </Link>
            );
          })}
        </div>
