  ...
  return (
    <div className="space-y-4">
      <Card className="border-green-200 border-2">
        <CardHeader>
          <CardTitle>System Demo Guide</CardTitle>
        </CardHeader>
        <CardContent>
          <p className="text-gray-600 text-sm mb-6">
            Follow these steps to learn all the key features of StockOS. This guide covers everything from basic setup to advanced reporting.
          </p>

          <div className="space-y-4">
            {demoSteps.map((item) => (
              <div key={item.step} className="border border-gray-200 rounded-lg p-4 hover:bg-gray-50">
                <div className="flex items-start gap-3">
                  <div className="flex items-center justify-center w-8 h-8 bg-green-600 text-white rounded-full flex-shrink-0 font-bold text-sm">
                    {item.step}
                  </div>
