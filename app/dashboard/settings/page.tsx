    ...
    <div className="space-y-6">
      ...
      <Tabs defaultValue="general" className="space-y-4">
        <TabsList className="grid w-full grid-cols-2 md:grid-cols-5 gap-1 bg-gray-100 p-1">
          ...
          {(isAdmin || isManager) && <TabsTrigger value="credentials" className="text-xs md:text-sm">Credentials</TabsTrigger>}
        </TabsList>
      ...
      <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
        <p className="text-sm text-blue-900">
          <strong>Note:</strong> All settings are saved automatically. Changes to currency and units will be reflected across the entire system.
        </p>
      </div>
    </div>
  );
